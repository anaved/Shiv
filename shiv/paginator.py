...
class Page(object):
    def __init__(self, object_list, number, paginator):
        ...
        if paginator.request:
            ...
            self.base_queryset['start'] = 'start'
            self.base_queryset = self.base_queryset.urlencode().replace('%', '%%').replace('start=start', 'start=%s')
    ...
    def render(self):
        return render_to_string('common/pagination.html', {
            'current_page':self,
