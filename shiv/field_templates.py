...
REMEMBERME_FIELD = u'''
                <br /><div class="rmbrHeader">%(field)s<span class="headerTxt"><div class="rmbrText">%(label)s</div></span></div>
              '''

AGREECONDITIONS_FIELD = u'''
                %(field)s <span class="lblTxt">I agree to <a href="/terms/" target="_none">Terms and Conditions</a></span>
              '''
